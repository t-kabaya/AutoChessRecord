...
export const synergyLevel2Condition = [
  ...
  { synergy: en.siegeBreaker, count: 7 },

  { synergy: en.longShot, count: 6 },
  { synergy: en.longShot, count: 7 },

  { synergy: en.blaster, count: 6 },
  { synergy: en.blaster, count: 7 },

  { synergy: en.assassin, count: 6 },
  { synergy: en.assassin, count: 7 },

  /* -------------------- 4 units --------------------- */
  /* -------------------- job --------------------- */
  { synergy: en.guardian, count: 4 },
  { synergy: en.guardian, count: 5 },

  { synergy: en.supporter, count: 4 },
  { synergy: en.supporter, count: 5 },

  { synergy: en.vanguard, count: 3 },
  { synergy: en.vanguard, count: 4 },
  { synergy: en.vanguard, count: 5 },

  { synergy: en.marine, count: 4 },
  { synergy: en.marine, count: 5 },

  { synergy: en.mech, count: 4 },
  { synergy: en.mech, count: 5 },

  { synergy: en.airForce, count: 4 },
  { synergy: en.airForce, count: 5 },

  { synergy: en.puppet, count: 4 },
  { synergy: en.puppet, count: 5 },

  { synergy: en.psyker, count: 4 },
  { synergy: en.psyker, count: 5 },

  { synergy: en.kraken, count: 4 },
  { synergy: en.kraken, count: 5 },

  { synergy: en.beast, count: 4 },
  { synergy: en.beast, count: 5 },

  { synergy: en.rapter, count: 4 },
